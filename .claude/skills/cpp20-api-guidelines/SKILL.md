...
- Use absl::StatusOr<T> for recoverable errors, absl::flat_hash_map for hash containers,
  absl::Duration/Time for time, absl::StrCat/StrFormat for string operations.
