...
[[nodiscard]] constexpr size_t numeric_type_size(NumericType type) noexcept {
  switch (type) {
    case NumericType::kFloat32: return sizeof(float);
    case NumericType::kFloat64: return sizeof(double);
    case NumericType::kInt8:    return sizeof(int8_t);
    case NumericType::kInt16:   return sizeof(int16_t);
    case NumericType::kInt32:   return sizeof(int32_t);
    case NumericType::kInt64:   return sizeof(int64_t);
    case NumericType::kUint8:   return sizeof(uint8_t);
    case NumericType::kUint16:  return sizeof(uint16_t);
    case NumericType::kUint32:  return sizeof(uint32_t);
    case NumericType::kUint64:  return sizeof(uint64_t);
  }
